...
def make_quality_compression(original,sal):
    ...
    compressed_1 = args.output_directory + '/' + '_original_' + args.image.split('/')[-1] + '_' + str(args.jpeg_compression) + '_' + '.jpg'
    compressed_2 = args.output_directory + '/' + '_original_' + args.image.split('/')[-1] + '_' + str(args.jpeg_compression) + '_' + '.bpg'
    original.save(compressed_1, quality=100)
    os.system('bpgenc -q ' + args.jpeg_compression + ' ' + compressed_1 + ' ' + compressed_2)
    ...
    if args.find_best:
        ...
        for fq in final_quality:
            ...
            out_name_1 = args.output_directory + '/' + args.modifier + args.image.split('/')[-1] + '_' + str(fq) + '_' + '.jpg'
            out_name_2 = args.output_directory + '/' + args.modifier + args.image.split('/')[-1] + '_' + str(fq) + '_' + '.bpg' 
            out_img.save(out_name_1, quality=100)
            os.system('bpgenc -q ' + fq + ' ' + out_name_1 + ' ' + out_name_2)
