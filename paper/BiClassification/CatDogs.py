...
data_dir = '/mnt/md0p1/GPH/AAAA/dogs-vs-cats/data'
    ...
    for epochs in range(num_epochs):
        ...
        for phase in ['train','val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                ...
                msg = 'Saving checkpoint: {}'.format(epochs + 1)
                print(msg)
                ...
                torch.save(
                    ...
                    os.path.join(save_dir, '%03d.ckpt' % (epochs + 1))
                )
...
import os
save_dir = os.path.join('./model/vgg16_' + datetime.now().strftime('%Y%m%d_%H%M%S'))
