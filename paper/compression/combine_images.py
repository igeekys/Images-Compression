...
parser.add_argument('-map'              , type=str , default= 'input/image_roi_map.jpg')
...
parser.add_argument('-threshold_pct'    , type=int , default=0) # 20

# if you have Imagemagick installed, use convert it is faster
parser.add_argument('-use_convert'      , type=int , default=1) # 0
...
# ??
parser.add_argument('-model'            , type=int , default=3) # default 3
...
parser.add_argument('-print_metrics'    , type=int , default=1)
...
def make_quality_compression(original,sal):
    ...
    compressed = args.output_directory + '/' + '_original_' + args.image.split('/')[-1] + '_' + str(args.jpeg_compression) + args.map[6:-12] +'.jpg'
    ...
    if args.find_best:
        out_name = args.output_directory + '/' + '_compressed_' + args.image.split('/')[-1] + '_'  + args.map[6:-12] + '.jpg'
